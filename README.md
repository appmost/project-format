...
- `examples/row-catalog.appmostapp/` — the cross-platform row reference project
...
| --- | ---: | ---: | ---: |
| Row types | 93/93 | 93/93 | 93/93 in the SwiftUI preview |
...
[`examples/row-catalog.appmostapp`](examples/row-catalog.appmostapp)
contains all 93 public row types and focused pages for Action, Content, Input,
Layout, Media, Data, and Location examples. It is the shared cross-platform
fixture for the iOS and Android screenshots on [appmost.ai/format](https://www.appmost.ai/format/).

Validate it with:

```sh
npm run validate -- examples/row-catalog.appmostapp
```
